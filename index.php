 ...
 <div class ="container">
   <div class ="row justify-content-center">
      <div class="logForm col-6 col-md-6 text-center">
        <form action="https://ualr.edu/news/" method="post">
          <input type="submit" value="UALR News" class="buttons btn btn-lg btn-primary btn-block">
        </form>
      </div>
      <div class="logForm col-6 col-md-6 text-center">
        <form action="https://ualr.edu/records/faq/" method="post">
          <input type="submit" value="UALR FAQ" class="buttons btn btn-lg btn-primary btn-block">
        </form>
      </div>
      </div>
</div>
